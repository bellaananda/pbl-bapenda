                                                        ...
                                                        <form action="/bidang/{{$item['id']}}" method="POST" enctype="multipart/form-data" id="updateForm{{ $item['id'] }}">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label for="name" class="font-weight-bold">Nama Bidang</label>
                                                                    <span class="required-field">*</span>
                                                                    <input type="text" class="form-control" id="update_name{{ $item['id'] }}" name="name" placeholder="Masukkan Nama Bidang" value="{{ old('name', $item['name']) }}" required>
                                                                    @error('name')
                            ...
                            <div class="card-title">
                                ...
                                <form action="/bidang" method="post" id="createForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="required-field">*</span>
                                        <input type="text" class="form-control" id="create_name" name="name" placeholder="Masukkan Nama Bidang" value="{{ old('name') }}" required>
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
