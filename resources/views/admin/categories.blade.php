...
@section('main')
    <div class="main-panel">
        <div class="content-wrapper">
            <h3 class="font-weight-bold">KELOLA DATA KATEGORI AGENDA</h3>
            <div class="row pt-3">
                <div class="col-md-6">
                    <div class="card-body">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Data Kategori Agenda</h4>
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="/kategori/{{$item['id']}}" method="POST" id="deleteForm{{ $item['id'] }}" style="display: inline">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title display-5" id="editModalLabel">Edit Kategori</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form action="/kategori/{{$item['id']}}" method="POST" enctype="multipart/form-data" id="updateForm{{ $item['id'] }}">
                                                            @csrf
                                                            @method('PUT')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                ...
                                <form action="/kategori" method="post" id="createForm">
                                    @csrf
                                    <div class="form-group">
