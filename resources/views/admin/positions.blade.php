...
@section('main')
    <div class="main-panel">
        <div class="content-wrapper">
            <h3 class="font-weight-bold">KELOLA DATA POSISI PEGAWAI</h3>
            <div class="row pt-3">
                <div class="col-md-6">
                    <div class="card-body">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Data Posisi Pegawai</h4>
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="/posisi/{{$item['id']}}" method="POST" id="deleteForm{{ $item['id'] }}" style="display: inline">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title display-5" id="editModalLabel">Edit Posisi Pegawai</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form action="/posisi/{{$item['id']}}" method="POST" enctype="multipart/form-data" id="updateForm{{ $item['id'] }}">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label for="name" class="font-weight-bold">Nama Posisi</label>
                                                                    <span class="required-field">*</span>
                                                                    <input type="text" class="form-control" id="update_name{{ $item['id'] }}" name="name" placeholder="Masukkan Nama Posisi Pegawai" value="{{ old('name', $item['name']) }}" required>
                                                                    @error('name')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4 class="card-title">Tambah Posisi Pegawai</h4>
                                <form action="/posisi" method="post" id="createForm">
                                    @csrf
                                    <div class="form-group">
                                        <label for="name">Nama Posisi</label>
                                        <span class="required-field">*</span>
                                        <input type="text" class="form-control" id="create_name" name="name" placeholder="Masukkan Nama Posisi Pegawai" value="{{ old('name') }}" required>
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
