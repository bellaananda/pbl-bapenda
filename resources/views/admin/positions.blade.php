                                                        ...
                                                        <form action="/posisi/{{$item['id']}}" method="POST" enctype="multipart/form-data" id="updateForm{{ $item['id'] }}">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan Nama Posisi Pegawai" value="{{ old('name', $item['name']) }}" required>
                                                                    @error('name')
                            ...
                            <div class="card-title">
                                ...
                                <form action="/posisi" method="post" id="createForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="required-field">*</span>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan Nama Posisi Pegawai" value="{{ old('name') }}" required>
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
