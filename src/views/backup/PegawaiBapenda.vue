                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <tr v-for="(user, index) in users.data" :key="user.id">
                        ...
                        <td>{{ user.name }}</td>
                        <td>
                          <a href="" class="btn btn-sm btn-primary" @click.prevent="editEmployee(user)" data-toggle="modal" data-target="#modalUpdate">
                            <i class="mdi mdi-pencil btn-icon-prepend"></i>
                          </a>
                          <a href="" class="btn btn-sm btn-danger" @click.prevent="deleteEmployee(user.id)">
