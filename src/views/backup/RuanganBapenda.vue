              ...
              <form class="forms-sample" @submit.prevent="createRoom()">
                <div class="modal-body">
                  <div class="form-group">
                    <label for="inputRooms">Nama Ruang</label>
                      <input type="text" class="form-control" v-model="form.name" :class="{ 'is-invalid': form.errors.has('name') }" id="inputRooms" placeholder="Ruang">
...
import swal from 'sweetalert2';
  ...
  export default {
      ...
      methods: {
        ...
        // editRoom(room){
        //   this.isFormCreateRoomsMode = false;
